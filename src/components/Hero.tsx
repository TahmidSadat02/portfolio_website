      ...
      <div className="grid grid-cols-1 md:grid-cols-2 min-h-screen">
        ...
        <div className="absolute inset-0 md:relative md:inset-auto overflow-hidden opacity-30 md:opacity-100 min-h-screen md:min-h-0 pointer-events-none md:pointer-events-auto">
          ...
          <motion.img
            ...
            style={{ x: imgX, y: imgY }}
            className="absolute top-0 md:top-20 bottom-0 right-0 h-full md:h-[calc(100%-5rem)] w-[90%] md:w-[80%] object-cover object-top grayscale contrast-110 mask-image-bottom"
